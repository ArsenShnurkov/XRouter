...
namespace TrafficPolice.Tests
{
  ...
  {
    private const string DirectoryPath = @"E:\2012\TrafficPolice\TrafficPolice.Tests\";
    ...
    [Test]
    public void Route_Redirect_Test()
    {
      // arrange
      var routeSource = new XRouteSource("routes_redirect.config");
      routeSource.DirectoryPath = DirectoryPath;
      ...
      Assert.AreEqual(true, routeItemToTest.Redirect);
      Assert.AreEqual("/category", routeItemToTest.Pattern);
      Assert.AreEqual("/tag", routeItemToTest.RedirectParams.RedirectTo);
      Assert.AreEqual(true, routeItemToTest.RedirectParams.IsPermanent);
    }
    ...
    public void Route_Areas_Folder_Test()
    {
      // arrange
      var routeSource = new XRouteSource("routes.config");
      routeSource.DirectoryPath = @"E:\2012\TrafficPolice\TrafficPolice.Tests\Test\";
